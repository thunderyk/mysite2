				...
				<div id="modifyForm">
					<form action="./user" method="post">
						...
						<div class="form-group">
							...
							<input type="text" id="input-pass" name="password" value="${requestScope.userVo.password}" placeholder="비밀번호를 입력하세요"	>
						</div>
						...
						<input type="hidden" name="uid" value="${requestScope.userVo.id}">
						<input type="hidden" name="uno" value="${requestScope.userVo.no}">
